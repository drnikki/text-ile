...
for (let i = 0; i < 100; i++) {
  ...
  let clouds = imposeBlocks(
    "<br/>".repeat(cloudPositions[0]) + printClouds(),
    "<br/>".repeat(cloudPositions[1]) + printClouds()
  );
  clouds = imposeBlocks(
    clouds,
    "<br/>".repeat(cloudPositions[2]) + printClouds()
  );
  clouds =
    imposeBlocks(clouds, "<br/>".repeat(cloudPositions[3]) + printClouds()) +
    "<br/><br /><br />";
...
for (let i = 0; i < 100; i++) {
  ...
  receiptCloudteca +=
    printPeteca(1 + Math.floor(Math.random() * 11)) + "<br />"; // pateca on the left
  receiptCloudteca += printGradientFloor() + "<br />";
}
